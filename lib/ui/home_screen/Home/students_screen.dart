...
//
//     return Padding(
//       // ✅ reduce vertical padding قليلاً لأن SafeArea already adds top padding
//       padding: EdgeInsets.symmetric(horizontal: 20.w, vertical: 16.h),
//       child: Column(
//         crossAxisAlignment: CrossAxisAlignment.start,
//         children: [
...
//                 const Spacer(),
//                 // IconButton(
//                 //   icon: Icon(Icons.logout, color: scheme.textMainBlack, size: 22.sp),
...
//                 bottom: 12.h, // ✅ ensures last row visible above gesture bar
//               ),
//               physics: const BouncingScrollPhysics(),
//               itemCount: students.length,
//               gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
