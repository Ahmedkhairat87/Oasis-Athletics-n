...
class StudentsScreen extends StatelessWidget {
  ...
  /// ✅ جديد: يظهر loading overlay خفيف فوق الشاشة
  final bool isRefreshing;

  /// ✅ جديد: callback للـ refresh (اختياري)
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          /// 🔹 UI الأصلي زي ما هو
          AppBackground(child: _content(context)),

          /// 🔹 Loading overlay خفيف (من غير solid screen)
          if (isRefreshing)
            Positioned(
  ...
  /// ✅ هنا بقى كل UI القديم بتاعك من غير تغيير
  Widget _content(BuildContext context) {
    ...
    // (secondaryBlue كان موجود عندك لكن مش مستخدم — سيبته برضه لو هتحتاجه)
