// lib/core/model/stdLinks/medicalFormData/StdMedicalFormData.dart

class StdMedicalFormData {
  StdMedicalFormData({
    this.historyID,
    this.studentID,
    this.bloodGroupID,
  ...
  dynamic hasAllergies; // bool or 0/1
  String? allergyType;
  ...
  dynamic hearingProblems; // bool or 0/1
  dynamic hearingAid; // bool or 0/1
  ...
  dynamic selectedAllergies; // List or String
  dynamic selectedInjuries; // List or String
  dynamic selectedSurgeries; // List or String

  String? bloodGroupName;

  factory StdMedicalFormData.fromJson(dynamic json) {
    return StdMedicalFormData(
